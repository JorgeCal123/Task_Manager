 ...
 * /api/tasks:
 *   get:
 *     summary: Obtener lista de tareas por estado
 *     tags: [Tasks]
 *     parameters:
 *       - in: query
 *         name: completed
 ...
 *                 $ref: '#/components/schemas/Task'
 */
router.get('/', taskValidation.filterTasksValidation, taskController.getTasks);
 ...
 */
router.get('/:id', taskValidation.getTaskValidation, taskController.getTaskById);
 ...
 *         description: Tarea no encontrada
 */
router.delete('/:id', taskValidation.getTaskValidation, taskController.deleteTask);
